...
Similarly, the `resid_space` function is designed to plot spatial residuals (again these have mean 0). And faceting can be turned on / off, but by default `by_time = TRUE`.
