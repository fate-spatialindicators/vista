...
vignette: >
  %\VignetteDepends{sdmTMB,remotes,foreach}
...
# try to also install INLA, a dependency for sdmTMB
install.packages("INLA",repos="https://inla.r-inla-download.org/R/stable", dep=FALSE)
library(sdmTMB)
```
